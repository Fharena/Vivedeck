...
- extensions/vibedeck-bridge는 mock/command mode, 설정 기반 command ID 매핑, command registry readiness 검증, agent env 복사 명령, smoke command 복사를 제공하는 설치 가능한 extension package입니다.
