...
- 모바일 bootstrap 자동 세팅 v3 (UDP LAN discovery `:42777`, 같은 Wi-Fi host 자동 탐지/적용, 최근 세션 추천 강화)

## 다음 작업 우선순위

1. Cursor 세션 복원/로그 가시성 고도화
2. research/text-first 경로 분리로 외부 정보 문서 작성 흐름 보강
